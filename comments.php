		...
		if ( have_comments() ) :
			...
			<h3 class="comments-title">
				...
				if ( '1' === $bootstrap2wordpress_comment_count ) {
					printf(
						/* translators: 1: title. */
						esc_html__( 'Un commentaire sur &ldquo;%1$s&rdquo;', 'bootstrap2wordpress' ),
						'<span>' . get_the_title() . '</span>'
					);
				} else {
					printf( // WPCS: XSS OK.
						/* translators: 1: comment count number, 2: title. */
						esc_html( _nx( '%1$s commentaire sur &ldquo;%2$s&rdquo;', '%1$s commentaires sur &ldquo;%2$s&rdquo;', $bootstrap2wordpress_comment_count, 'comments title', 'bootstrap2wordpress' ) ),
