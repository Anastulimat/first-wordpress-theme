...
if ( ! function_exists( 'bootstrap2wordpress_setup' ) ) :
	...
	function bootstrap2wordpress_setup() {
		...
		register_nav_menus( array(
			...
			'secondary' => esc_html__( 'Secondary', 'bootstrap2wordpress' ),
		) );
...
function bootstrap2wordpress_scripts() {
	...
	wp_register_script( 'bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js', [
		'popper',
		'jquery'
	], false, true );
	...
	wp_enqueue_script( 'bootstrap2wordpress-main', get_template_directory_uri() . '/assets/js/main.js', array(), '', true );
...
/**
 * Add classes to nav item in menu to adapt the style with bootstrap style
 *
 * @param array $classes
 *
 * @return array
 */
function bootstrap2wordpress_nav_menu_css_class(array $classes) {
	$classes[] = 'nav-item';
	return $classes;
}
add_filter('nav_menu_css_class', 'bootstrap2wordpress_nav_menu_css_class');

/**
 * Add classes to nav link in menu to adapt the style with bootstrap style
 *
 * @param array $attrs
 *
 * @return array
 */
function bootstrap2wordpress_nav_menu_link_attributes(array $attrs) {
	$attrs['class'] = 'nav-link';
	return $attrs;
}
add_filter( 'nav_menu_link_attributes', 'bootstrap2wordpress_nav_menu_link_attributes' );
...
/**
 * Change the excerpt [...] by link to the post
 * @return string
 */
function new_excerpt_more() {
	global $post;
	return '... <a class="moretag" href="' . get_permalink($post->ID) . '"> continuer à lire &raquo;</a>';
}
